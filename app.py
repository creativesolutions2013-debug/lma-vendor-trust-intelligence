    ...
    if extraction:
        ...
        if confidence_text == "High":
            st.success(
                ...
                "key SOC 2 metadata was "
                "successfully identified. "
                "Analyst validation is "
                "still required."
            )
