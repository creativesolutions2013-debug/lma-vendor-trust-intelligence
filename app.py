...
def clear_soc2_extraction_state():
    """
    Clear temporary SOC 2 extraction state.

    Persisted database evidence is not affected.
    """
...
def initialize_evidence_form(
    ...
    """
    Initialize a clean evidence form whenever
...
def populate_evidence_form_from_extraction(
    ...
    """
    Populate evidence-registration fields only with
    extraction results belonging to this file.
    """
...
def render_evidence():
    ...
    st.caption(
        ...
        "coverage, provenance, and key report metadata."
    )
    ...
    # -----------------------------------------------------
    # Load extraction only when it belongs to
    ...
    # -----------------------------------------------------
    # File-specific registration keys
    # -----------------------------------------------------
        ...
        with st.expander(
            ...
            if selected.file_hash:
                ...
                st.caption(
                    ...
                    "uploaded document associated with this "
                    "evidence record."
                )
